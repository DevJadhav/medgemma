        ...
        <div className="min-h-screen bg-gray-50/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <Card>
                        <CardHeader>
                            <h2 className="text-xl font-bold text-gray-900">Safety Playground</h2>
                        </CardHeader>
                    ...
                    {/* Results Area */}
                    {testResult && (
                        <Card className={testResult.is_safe ? "border-l-4 border-l-emerald-500" : "border-l-4 border-l-red-500"}>
                            <CardHeader>
                                <div className="flex items-center justify-between">
                                    <h3 className="font-bold text-gray-900">Analysis Result</h3>
                                    <span className={`px-3 py-1 rounded-full text-sm font-bold ${testResult.is_safe ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"}`}>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="font-semibold text-gray-700">Jailbreak Detection</span>
                                        <span className={`text-xs font-bold uppercase ${testResult.jailbreak.detected ? "text-red-600" : "text-emerald-600"}`}>
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="font-semibold text-gray-700">Prompt Injection</span>
                                        <span className={`text-xs font-bold uppercase ${testResult.injection.detected ? "text-red-600" : "text-emerald-600"}`}>
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="font-semibold text-gray-700">Medical Scope</span>
                                        <span className={`text-xs font-bold uppercase ${testResult.scope.is_valid ? "text-emerald-600" : "text-amber-600"}`}>
                                            {testResult.scope.is_valid ? "VALID" : "OUT OF SCOPE"}
                                        </span>
                                    </div>
                                    <div className="text-sm text-gray-600">
                                        {testResult.scope.scope ? (
                                            <p>Type: <span className="font-medium bg-blue-100 text-blue-800 px-2 py-0.5 rounded">{testResult.scope.scope}</span></p>
                                        ) : (
                ...
                <div className="space-y-6">
                    <Card className="h-full">
                        <CardHeader>
                            <h2 className="text-xl font-bold text-gray-900">Active Configurations</h2>
                        </CardHeader>
                        <CardContent>
                            {configLoading ? (
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {config.jailbreak_categories.map(cat => (
                                                <span key={cat} className="px-2 py-1 bg-red-50 text-red-700 border border-red-100 rounded text-xs font-medium">
                                                    {cat}
                                                </span>
                                            ))}
                                        </div>
